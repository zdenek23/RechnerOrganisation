...
echo "a1.c with test_input_rpn0.txt" 
./a1 < testbed/test_inputs/input_rpn0.txt > testbed/test_out.txt
...
echo "a1.c with test_input_rpn0m.txt" 
./a1 < testbed/test_inputs/input_rpn0m.txt > testbed/test_out.txt
...
echo "a1.c with test_input_rpn1.txt" 
./a1 < testbed/test_inputs/input_rpn1.txt > testbed/test_out.txt
...
echo "a1.c with test_input_rpn1m.txt" 
./a1 < testbed/test_inputs/input_rpn1m.txt > testbed/test_out.txt
...
echo "a1.c with test_input_rpn2.txt" 
./a1 < testbed/test_inputs/input_rpn2.txt > testbed/test_out.txt
...
echo "a1.c with test_input_rpn2m.txt" 
./a1 < testbed/test_inputs/input_rpn2m.txt > testbed/test_out.txt
...
echo "a1.c with test_input_rpn3.txt" 
./a1 < testbed/test_inputs/input_rpn3.txt > testbed/test_out.txt
...
echo "a1.c with test_input_rpn3m.txt" 
./a1 < testbed/test_inputs/input_rpn3m.txt > testbed/test_out.txt
...
echo "a1.c with test_input_rpn4.txt" 
./a1 < testbed/test_inputs/input_rpn4.txt > testbed/test_out.txt
