...
MAIN LDA    RF  0xF0            ;initialize stack pointer
     ...
     LDA    R4  0               ;int controller;
                                ;
    SUB RF  RF  R1              ;prolog
    STI RE  RF                  ;save base pointer
    ADD RE  RF  R0              ;set base pointer of MAIN
    SUB RF  RF  R1              ;set stack pointer for 1 variable
                                ;int main(){
                                ;
A0  JL  RD  LL0                 ;A0:my_getchar();
    JL  RD  CC                  ;check_char();
...
LL0 SUB RF  RF  R1              ;prolog:
    STI RD  RF                  ;push RD, end prolog
    JL  RD  POL                 ;call pulling routine
    LD  RC  0xFF                ;RC = getchar();
    LDI RD  RF                  ;epilog: copy the return adress from TOS into RE
